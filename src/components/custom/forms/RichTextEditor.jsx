...
function RichTextEditor({ onRichTextChange,index,defaultValue}) {
  ...
  const prompt=`just only depends on ${resumeInfo?.experience[index]?.title}(this job title) give me 5-7 bullet points for my experience in resume (Please do not add experince level and also do not add JSON array format) , give me result just in HTML tags everytime uniquely.`;
